            ...
            <form id='form' onSubmit={handleSubmit(onSubmit)} className='max-w-[455px] w-full mx-auto rounded-lg bg-gray-900 p-8 px-8'>
                ...
                <div className='flex flex-col text-gray-400 mt-1 py-2'>
                    <div className='flex justify-between'>
                        <label>Ammy ID</label>
                        <h1 className=' text-red-500'>{errors.aadhar?.type === "required" && "User number is required"}
                        {errors.aadhar?.type === "minLength" && "User number cannot be less than 12 digits"}
                        {errors.aadhar?.type === "maxLength" && "User number cannot be more than 12 digits"}</h1>
                    </div>
